          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-xs text-sm leading-relaxed text-slate-500">
                The all-in-one intelligent ERP platform for manufacturing, retail, healthcare, education and more.
              </p>
            </div>

            {/* Product */}
            <div>
              <h4 className="mb-4 text-sm font-bold uppercase tracking-wider text-slate-400">Product</h4>
              <ul className="space-y-2.5 text-sm text-slate-600">
                ...
                <li><a href="#dashboard" className="transition hover:text-slate-950">Dashboard</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-slate-600">
                <li><a href="#" className="transition hover:text-slate-950">Documentation</a></li>
                <li><a href="#" className="transition hover:text-slate-950">API Reference</a></li>
                <li><a href="#faq" className="transition hover:text-slate-950">FAQ</a></li>
                <li><a href="#" className="transition hover:text-slate-950">Help Center</a></li>
              </ul>
            </div>

            {/* Company */}
            <div>
              <h4 className="mb-4 text-sm font-bold uppercase tracking-wider text-slate-400">Company</h4>
              <ul className="space-y-2.5 text-sm text-slate-600">
                <li><a href="#" className="transition hover:text-slate-950">About</a></li>
                <li><a href="#" className="transition hover:text-slate-950">Contact</a></li>
                <li><a href="#" className="transition hover:text-slate-950">Blog</a></li>
                <li><a href="#" className="transition hover:text-slate-950">System Status</a></li>
              </ul>
            </div>
          </div>
